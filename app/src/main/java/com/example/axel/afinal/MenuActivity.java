...
public class MenuActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_perfil) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new PerfilActivity()).commit();
            ...
            fragmentManager.beginTransaction().replace(R.id.contenedor,new MarcasActivity()).commit();
        } else if (id == R.id.nav_tecnico) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new TecnicoActivity()).commit();
        }
